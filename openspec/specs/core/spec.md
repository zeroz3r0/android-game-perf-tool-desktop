...
> **Source delta:** `in-app-dep-bootstrap` (archived 2026-05-12). All requirements in this section were added by that change.

### Requirement: DEP-001 — App detects missing adb at startup
...
### Requirement: DEP-002 — App detects missing ffmpeg when recording
...
### Requirement: DEP-003 — Download succeeds with progress feedback
...
### Requirement: DEP-004 — Download fails gracefully with proxy error
...
### Requirement: DEP-005 — Manual fallback for download failures
